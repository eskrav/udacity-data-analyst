...
```{r}
profit <- c("LenderYield", "EstimatedEffectiveYield", "EstimatedLoss", "EstimatedReturn", "CurrentDelinquencies", "AmountDelinquent", "OnTimeProsperPayments", "LoanCurrentDaysDelinquent", "LP_GrossPrincipalLoss", "LP_NetPrincipalLoss","ProsperRating..numeric.")
...
```{r}
subset <- c("EstimatedReturn", "EstimatedEffectiveYield", "EstimatedLoss", "LenderYield", "ProsperRating..numeric.","Occupation")

plot_data <- data[subset] %>% 
  group_by(Occupation) %>% 
  summarize_all(funs(mean(., na.rm = TRUE))) %>%
  mutate(Occupation = reorder(Occupation, ProsperRating..numeric., mean)) %>%
...
```{r}
subset <- c("EstimatedReturn", "EstimatedEffectiveYield", "EstimatedLoss", "LenderYield", "ProsperRating..numeric.","IncomeRange")
